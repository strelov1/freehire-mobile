# job-card-profile-match

## Purpose

Computing and displaying, on the mobile feed's job cards, how well a job's
skills overlap with the signed-in user's saved profile skills — via tinted
skill chips and a match progress bar. TBD: expand as the capability grows.
